...
typedef struct MarkovChain {
    ...
    // and returns a newly allocated copy of it returns a generic pointer.
    copy_func copy_func;
...
/**
 * initializes a new MarkovNode for the LinkedList with the word found in the
 * file. Creates all needed structs and allocates memory of them.
 * @param cur_word
 * returns the created markov node.
 */
